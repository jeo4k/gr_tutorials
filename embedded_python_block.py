...
import embedded_python_block_epy_block_0 as epy_block_0  # embedded python block
import sip



class embedded_python_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "embedded_python_block")
...
def main(top_block_cls=embedded_python_block, options=None):
