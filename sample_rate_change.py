...
class sample_rate_change(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sample_rate_change")
...
def main(top_block_cls=sample_rate_change, options=None):
